          ...
          <el-col :span="18">
            ...
            <div id="searchBox" class="panel">
              <el-input
                maxlength="20"
                minlength="2"
                placeholder="输入关键字词, 开始检索您感兴趣的方案"
            ...
            <div class="project-list" v-loading="taskListLoad">
              <!-- 列表项 -->
              <el-row class="row-shadow" v-for="item in taskList.data" :key="item.id">
                <el-col :span="24">
                  <img
                    ...
                    <el-col :span="19">
                      ...
                      <el-row>
                        <el-col :span="18">
                          <div class="tags">
                            <!-- <strong
                              style="margin-right:8px;font-size:14px;color:#48576a"
                              >支持的客户端</strong
                            > -->
                      ...
                      <div class="other">
                        <el-row>
                          ...
                          <el-col :span="16">
                            <span class="skills">
                              <!-- 应用场景：电商平台后端，支持微信小程序、H5 -->
                              好评率：{{item.percent}} | {{item.sales_num}}人购买 | {{item.shop.shop_name}}
                            </span>
                          </el-col>
...
export default {
  ...
  methods: {
    getTaskList() {
      ...
      _this.$axios.post("commodityLists", _this.taskType).then(res => {
        console.log(res);
  ...
  created() {
    ...
    //获取任务列表
    this.$axios.post("commodityLists").then(res => {
      if (res.data.code == 1000) {
